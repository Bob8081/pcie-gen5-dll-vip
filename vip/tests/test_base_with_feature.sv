class test_base_with_feature extends pcie_dll_test_base;
  ...
  `uvm_component_utils(test_base_with_feature)

  function new(string name = "test_base_with_feature", uvm_component parent = null);
  ...
  task run_phase(uvm_phase phase);
    ...
    repeat (4)
    begin
      `uvm_info("TEST", "Starting correct test with feature state for both RC and EP", UVM_LOW)
      fork
        begin
...
endclass : test_base_with_feature
